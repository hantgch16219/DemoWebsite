	...
	<div id="main">
			...
			<div id="sidebar_container">
			    ...
			    <div class="sidebar">
			        ...
			        <?php 
							...
							{
						?> 
							<li><a style=" font-size: 20px; text-decoration: none;" href="tes1.php?Categoryid=<?=$r['CategoryID']?>"><?=$r['CategoryName']?></a></li>
						<?php 
							}
						?>
        ...
        <div class="khuvuctrungbay">
			...
			for ($i=0; $i < count($rows) ; $i++) { 
				?>
					<div class="item">
						<a href="modeldetail.php?ProductID=<?=$rows[$i]['ProductID']?>"><div class="iimage"><img src="<?=$rows[$i]['Image']?>">
						</div></a>
